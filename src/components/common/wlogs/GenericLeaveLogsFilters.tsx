/**
 * Generic Leave Logs Filters - EXACT same structure as GenericAccessLogsFilters
 */

import React, { useState } from 'react';
import { useFilters } from '../../../hooks/useFilters';

interface GenericLeaveLogsFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
}

const GenericLeaveLogsFilters: React.FC<GenericLeaveLogsFiltersProps> = ({
  onFiltersChange,
  onClearFilters
}) => {
  const { 
      ...
      {showAdvanced && (
        <div className="px-6 py-4 bg-gray-50">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {renderSelect('leaveType', 'Leave Type', leaveTypeOptions)}
...
export default GenericLeaveLogsFilters;
