/**
 * Generic Late Logs Filters - EXACT same structure as GenericAccessLogsFilters
...
interface GenericLateLogsFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
}

const GenericLateLogsFilters: React.FC<GenericLateLogsFiltersProps> = ({
  onFiltersChange,
  onClearFilters
}) => {
  // Generic filter state - same pattern as Access Logs
  const { 
    filters, 
    updateFilter, 
    resetFilters, 
  ...
  const justifiedOptions = [
    { value: 'true', label: 'Justified' },
    { value: 'false', label: 'Not Justified' }
  ];

  const lateTypeOptions = [
  ...
  return (
    <div className="bg-white shadow-sm rounded-lg border border-gray-200 mb-6">
      {/* Search Bar - EXACT same structure as Access Logs */}
      ...
      {/* Advanced Filters - EXACT same structure as Access Logs */}
      {showAdvanced && (
        <div className="px-6 py-4 bg-gray-50">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Justified Filter */}
            {renderSelect('justified', 'Justified', justifiedOptions)}
            
            {/* Late Type Filter */}
            {renderSelect('lateType', 'Late Type', lateTypeOptions)}
          ...
          {/* Actions - EXACT same structure as Access Logs */}
...
export default GenericLateLogsFilters;
