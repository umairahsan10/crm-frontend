...
interface RevenuesSearchFiltersProps {
  ...
  onReceivedFromFilter: (leadId: string) => void;
  onRelatedInvoiceIdFilter: (invoiceId: string) => void;
  onClearFilters: () => void;
}

const RevenuesSearchFilters: React.FC<RevenuesSearchFiltersProps> = ({
  onSearch,
  onCategoryFilter,
  onSourceFilter,
  onDateRangeFilter,
  ...
  onReceivedFromFilter,
  onRelatedInvoiceIdFilter,
  onClearFilters
}) => {
  // Common state
  ...
  const handleReceivedFromChange = (value: string) => {
    ...
    onReceivedFromFilter(value);
  };

  const handleRelatedInvoiceIdChange = (value: string) => {
    setRelatedInvoiceId(value);
    onRelatedInvoiceIdFilter(value);
  };

  const hasActiveFilters = fromDate || toDate || minAmount || maxAmount || 
    paymentMethod || receivedFrom || relatedInvoiceId;
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  // Search also filters by category and source
                  onCategoryFilter(e.target.value);
                  onSourceFilter(e.target.value);
                }}
                placeholder="Search revenues by source, category, or lead..."
                className={`block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:${theme.ring} focus:border-green-600 sm:text-sm`}
              />
            </div>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:${theme.ring} focus:border-green-600 sm:text-sm`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleRelatedInvoiceIdChange(e.target.value)}
...
export default RevenuesSearchFilters;
