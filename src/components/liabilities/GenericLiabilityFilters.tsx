/**
 * Generic Liability Filters using new filter system
...
interface GenericLiabilityFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
}

const GenericLiabilityFilters: React.FC<GenericLiabilityFiltersProps> = ({
  onFiltersChange,
  onClearFilters
}) => {
  const { 
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search liabilities by name, category..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Loan, Payable"
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 sm:text-sm"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('isPaid' as any, e.target.value)}
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 sm:text-sm"
              >
            ...
            {/* Related Vendor */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Related Vendor ID</label>
              <input
                type="text"
                value={(filters.relatedVendorId as string) || ''}
                onChange={(e) => updateFilter('relatedVendorId' as any, e.target.value)}
...
export default GenericLiabilityFilters;
