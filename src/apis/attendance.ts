...
export const getLateLogs = async (query: any): Promise<any[]> => {
  try {
    ...
    const url = `/all-logs/late-logs${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
...
export const updateLateLogAction = async (logId: number, data: any): Promise<any> => {
  try {
    return await apiPutJson<any>(`/all-logs/late-logs/${logId}/action`, data);
  } catch (error: any) {
...
export const getLateLogsStats = async (query: any): Promise<any> => {
  try {
    ...
    const url = `/all-logs/late-logs/stats${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
    return await apiGetJson<any>(url);
  } catch (error: any) {
...
export const getHalfDayLogs = async (query: any): Promise<any[]> => {
  try {
    ...
    const url = `/all-logs/half-day-logs${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
    return await apiGetJson<any[]>(url);
  } catch (error: any) {
...
export const updateHalfDayLogAction = async (logId: number, data: any): Promise<any> => {
  try {
    return await apiPutJson<any>(`/all-logs/half-day-logs/${logId}/action`, data);
  } catch (error: any) {
...
export const getHalfDayLogsStats = async (query: any): Promise<any> => {
  try {
    ...
    const url = `/all-logs/half-day-logs/stats${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
    return await apiGetJson<any>(url);
  } catch (error: any) {
...
export const getLeaveLogs = async (query: any): Promise<any[]> => {
  try {
    ...
    const url = `/all-logs/leave-logs${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
    return await apiGetJson<any[]>(url);
  } catch (error: any) {
...
export const updateLeaveLogAction = async (logId: number, data: any): Promise<any> => {
  try {
    return await apiPutJson<any>(`/all-logs/leave-logs/${logId}/action`, data);
  } catch (error: any) {
...
export const getLeaveLogsStats = async (query: any): Promise<any> => {
  try {
    ...
    const url = `/all-logs/leave-logs/stats${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
    return await apiGetJson<any>(url);
  } catch (error: any) {
