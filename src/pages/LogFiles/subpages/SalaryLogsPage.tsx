...
interface SalaryLogsPageProps {
  onBack?: () => void;
}

const SalaryLogsPage: React.FC<SalaryLogsPageProps> = ({ onBack }) => {
  const { user } = useAuth();
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="mt-2 text-sm text-gray-600">Track and manage employee salary records and payments</p>
            </div>
