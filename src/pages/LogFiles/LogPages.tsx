  ...
  const logTypes: LogType[] = [
    {
      id: 'access-logs',
      name: 'Access Logs',
      description: 'View login/logout activities and access history',
      icon: (
    ...
    },
    {
      id: 'hr-logs',
      name: 'HR Logs',
      description: 'Human resources activities and employee management logs',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      id: 'late-logs',
      name: 'Late Logs',
      description: 'Late arrival tracking and management',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      id: 'half-day-logs',
      name: 'Half-Day Logs',
      description: 'Half-day attendance and work hour tracking',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
