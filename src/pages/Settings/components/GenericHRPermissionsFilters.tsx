...
interface GenericHRPermissionsFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
}

const GenericHRPermissionsFilters: React.FC<GenericHRPermissionsFiltersProps> = ({
  onFiltersChange,
  onClearFilters,
}) => {
  const { 
...
export default GenericHRPermissionsFilters;
