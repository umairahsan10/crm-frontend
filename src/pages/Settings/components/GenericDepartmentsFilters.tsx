...
interface GenericDepartmentsFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
  onCreateClick?: () => void;
}

const GenericDepartmentsFilters: React.FC<GenericDepartmentsFiltersProps> = ({
  onFiltersChange,
  onClearFilters,
  onCreateClick,
}) => {
...
export default GenericDepartmentsFilters;
