...
interface GenericAccountantPermissionsFiltersProps {
  onFiltersChange: (filters: any) => void;
  onClearFilters: () => void;
}

const GenericAccountantPermissionsFilters: React.FC<GenericAccountantPermissionsFiltersProps> = ({
  onFiltersChange,
  onClearFilters,
}) => {
  const { 
...
export default GenericAccountantPermissionsFilters;
